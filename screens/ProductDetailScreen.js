...
const ProductDetailScreen = ({ navigation }) => {
  ...
  const product = {
    ...
    breed: "Kohaku",
    price: 5000000,
    imageUrl: "https://file.hstatic.net/200000573099/file/thiet_ke_chua_co_ten__65__26169d23c20046ea8754593ffb1b3a9b_grande.png",
      ...
      <ScrollView style={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          {isDescriptionExpanded && (
            <Text style={styles.description}>
              ...
              Đặc điểm nổi bật:{'\n'}
              • Màu sắc tươi sáng, đặc trưng của dòng Kohaku{'\n'}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.ratingOverview}>
            ...
            <Text style={styles.ratingText}>{averageRating}/5 ({totalReviews} đánh giá)</Text>
          </View>
          {reviews.map((review, index) => (
            <View key={index} style={styles.reviewItem}>
              ...
              >
                <Text style={styles.initialText}>{getInitial(review.name)}</Text>
              </View>
